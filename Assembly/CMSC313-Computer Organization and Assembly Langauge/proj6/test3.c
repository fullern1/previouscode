 ...
 *  File: test3.c
 *
 *  This file tests what happens when a new frac block is created then
 * all previously created fracs are deleted and added to the list
 */
...
int main() {
  fraction *fp1, *fp2, *fp3, *fp4, *fp5, *fp6;
