...
class CipherMessage {
 ...
 private:
  ...
  //Takes deciphered message and computes log probability that it is correct
  double logProb(string message);

  //Deciphers given message
  string DecipherByOne(string mess);

  //Deciphers message split into two messages
  string DecipherByTwo();

  //Deciphers message split into three messages
  string DecipherByThree();

  //Deciphers message split into four messages
  string DecipherByFour();

  //Deciphers message split into five messages
  string DecipherByFive();

  //Deciphers message split into six messages
  string DecipherBySix();

  //Deciphers given message with given key
  string Decipher(string key, string message);
};
