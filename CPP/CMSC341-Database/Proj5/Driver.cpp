...
int main() {
  cout << "Test 4 sanity test showing working insert/etc:\n";
  ...
  /*
    Makes it through most of the words then segfaults?????
  ...
  cout << "removed 2000 words + try to remove 2000 nonexistant words\n";
  */
